...
Link: https://www.gns.cri.nz/data-and-resources/national-earthquake-information-database/#:~:text=Overview,arrival%20times%20of%20seismic%20waves.

Step-by-step evaluation:
- Findable: F-Score = 12/17
- Accessible: A-Score = 8/10
- Interoperable: I-Score = 5/8
- Reusable: R-Score = 5/7
...
# ✅ Save to final CSV
output_csv = "SelectData_LLM3_T02-2_gpt-4o.csv"
